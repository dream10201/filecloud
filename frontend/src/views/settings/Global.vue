    ...
    <form class="card" @submit.prevent="save">
      ...
      <div class="card-content">
        ...
        <i18n path="settings.brandingHelp" tag="p" class="small">
          <a class="link" target="_blank" href="https://filecloud.xyz/configuration/custom-branding">{{ $t('settings.documentation') }}</a>
        </i18n>
    ...
    <form v-if="isExecEnabled" class="card" @submit.prevent="save">
      ...
      <div class="card-content">
        <i18n path="settings.commandRunnerHelp" tag="p" class="small">
          <code>FILE</code>
          <code>SCOPE</code>
          <a class="link" target="_blank" href="https://filecloud.xyz/configuration/command-runner">{{ $t('settings.documentation') }}</a>
        </i18n>
